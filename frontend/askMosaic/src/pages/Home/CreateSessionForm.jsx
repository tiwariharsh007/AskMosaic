...
const CreateSessionForm = () => {
    ...
    const handleCreateSession = async (e) => {
        ...
        try {
            ...
            if(response.data?.sesssion?._id) {
                navigate(`/interview-prep/${response.data?.sesssion?._id}`);
            }
        } catch (error) {
    ...
    <div className='w-[90vw] md:w-[35vw] p-7 flex flex-col justify-center'>
        ...
        <form onSubmit={handleCreateSession} className='flex flex-col gap-3'>
            ...
            <Input
                ...
                label="Description"
                placeholder="(Briefly describe your goals or any specific areas you want to improve)"
                type="text"
            />

            {error && (
                <p className='text-xs text-red-500 pb-2.5'>
                    {error}
                </p>
            )}
