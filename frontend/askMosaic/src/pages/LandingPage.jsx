      ...
      <div className='container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
        ...
        <header className='flex justify-between items-center mb-16'>
          <div className="flex items-center gap-3">
            <img src={HERO_IMG} alt="AskMosaic Logo" className="w-10 h-10 object-contain"/>
        ...
        <div className='flex flex-col md:flex-row items-center'>
          ...
          <div className='w-full md:w-1/2'>
            <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-6'>
              ...
              sed voluptatibus fugiat minima debitis cum animi cupiditate porro odio
              similique ipsum qui a ea amet enim placeat architecto mollitia.
            </p>
        ...
        <div className='container mx-auto px-4 pt-16 pb-20'>
            <section className='mt-5'>
              ...
              <div className='flex flex-col items-center gap-8 '>
                {/* Firts 3 cards of features */}
                <div className='grid grid-cols-1 md:grid-cols-3 gap-8 2-full'>
